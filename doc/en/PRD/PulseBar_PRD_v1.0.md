...
| AC-11 | Hidden dashboard releases full presentation resources and reaches target recovery | Passed on current hardware: standalone-window post-close CPU averages 0.295%, and full window/Hosting/ViewGraph objects return to the cold baseline; warm footprint settles near 30–32 MiB |
