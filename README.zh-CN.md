...
- 菜单栏弹出式面板进入隐藏生命周期时会清除完整快照和图表历史；独立卡片窗口关闭时也会卸载 SwiftUI 内容并回到后台采样，详见[质量报告](doc/zh-CN/QUALITY_REPORT.md)。

详见[隐私政策](doc/zh-CN/PRIVACY.md)和[技术架构](doc/zh-CN/TS/PulseBar_Technical_Architecture_v1.0.md)。
...
长稳脚本必须显式提供时长和采样间隔，避免误启动长时间任务。当前验证证据和仍需执行的发行矩阵见[质量与验证报告](doc/zh-CN/QUALITY_REPORT.md)及[发布清单](doc/zh-CN/RELEASE_CHECKLIST.md)。
...
- [产品需求文档（PRD）](doc/zh-CN/PRD/PulseBar_PRD_v1.0.md)
- [技术架构文档（TS）](doc/zh-CN/TS/PulseBar_Technical_Architecture_v1.0.md)
- [实施基线与里程碑](doc/zh-CN/IMPLEMENTATION_PLAN.md)
- [系统指标 API 可用性报告](doc/zh-CN/TS/Milestone_0_API_Availability_Report.md)
- [质量与验证报告](doc/zh-CN/QUALITY_REPORT.md)
- [发布清单](doc/zh-CN/RELEASE_CHECKLIST.md)
- [App Store 元数据](doc/zh-CN/APP_STORE_METADATA.md)
- [隐私政策](doc/zh-CN/PRIVACY.md)
- [支持与已知限制](doc/zh-CN/SUPPORT.md)

## 支持与反馈

请通过 [GitHub Issues](https://github.com/xiaolin0429/PulseBar/issues) 提交问题或建议，并先阅读[支持与已知限制](doc/zh-CN/SUPPORT.md)。请勿在公开 Issue 中提交令牌、密码、会话信息或其他敏感数据。
